...
MAPPO_DIR = "mappo_env/outputs/sumo_mappo/ingolstadt1"
QMIX_DIR = "outputs/sumo_qmix"
MAPPO_ATN_DIR = "mappo_env/outputs/sumo_mappo/atn"
...
m = load_best_sumo_metrics(QMIX_DIR, "qmix")
if m:
    rows.append(m)



m = load_best_sumo_metrics(MAPPO_ATN_DIR, "MAPPO_ATN")
if m:
    rows.append(m)
