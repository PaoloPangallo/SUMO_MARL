...
NET_FILE = os.path.join(
    PROJECT_ROOT, "nets", "RESCO", "cologne3", "cologne3.net.xml"
)
ROUTE_FILE = os.path.join(
    PROJECT_ROOT, "nets", "RESCO", "cologne3", "cologne3.rou.xml"
)

OUT_DIR = "outputs"
SUMO_DIR = os.path.join(OUT_DIR, "sumo_mappo_attention", "cologne3")
