...
NET_FILE = os.path.join(
    PROJECT_ROOT, "nets", "RESCO", "ingolstadt21", "ingolstadt21.net.xml"
)
ROUTE_FILE = os.path.join(
    PROJECT_ROOT, "nets", "RESCO", "ingolstadt21", "ingolstadt21.rou.xml"
)

OUT_DIR = "outputs"
SUMO_DIR = os.path.join(OUT_DIR, "sumo_mappo_attention", "ingolstadt21")
