...
OUT_DIR = "outputs"
SUMO_DIR = os.path.join(OUT_DIR, "sumo_mappo", "ingolstadt21")
    ...
    return (
        ...
        .training(
            ...
            model={
                ...
                "custom_model_config": {
                    # 7 agenti * obs_dim (dopo padding)
                    "critic_obs_space": 7 * env_creator({}).observation_space.shape[0],
                },
            },
        )
        .multi_agent(
...
def main():
    ...
    print("\n" + "=" * 40)
    print(f"🚦 MAPPO Ingolstadt7 - SEED {CURRENT_SEED}")
    print("=" * 40, flush=True)
